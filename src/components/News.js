...
export class News extends Component {
  ...
  async componentDidMount(){
    ...
    let url="https://newsapi.org/v2/top-headlines?country=in&apiKey=1f6ad8b5b03c40ba8e058d010885acc4&page=1pageSize=21";
   ...
   handlePrevClick = async()=>{
    console.log("prev");
    let url=`https://newsapi.org/v2/top-headlines?country=in&apiKey=1f6ad8b5b03c40ba8e058d010885acc4&page=${this.state.page - 1}&pageSize=21`;
    let data= await fetch(url);
    let parsedData = await data.json();
    console.log(parsedData);
    this.setState({
